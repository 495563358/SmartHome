...
@interface FitmentViewController ()<CLLocationManagerDelegate,UITableViewDelegate,UITableViewDataSource,UIPickerViewDelegate,UIPickerViewDataSource,AYPlaceViewDelegate>{
...
-(void)createViewthree{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        //        btn1.imageEdgeInsets = UIEdgeInsetsMake(0, 60, 0, 0);
        //        if (i>1) {
        //            btn1.imageEdgeInsets = UIEdgeInsetsMake(0, 80, 0, 0);
        //        }
...
-(void)downLoadResource{
    ...
    [[ObjectTools sharedManager] POST:path parameters:nil progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        if(self.mdata.count%10 == 0){
            __block FitmentViewController *weakSelf = self;
