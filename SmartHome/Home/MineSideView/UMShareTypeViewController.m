...
//    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:UMS_Title descr:UMS_Web_Desc thumImage:thumbURL];
    ...
    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:_titleName descr:_typeName thumImage:_imageUrl];
    
    
    //设置网页地址
    
    shareObject.webpageUrl = _shareLink;
