...
#define JPASSWORD @"an unbreakable cryptographic key" //解密
#define PASSWORD @"xiang ge mi ma zhe me nan"

static const char encodingTable[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
//128 / 256 加密解密
const NSUInteger kAlgorithmKeySize = kCCKeySizeAES128;
const NSUInteger kPBKDFRounds = 233;  // ~80ms on an iPhone 4
const NSUInteger JkPBKDFRounds = 110;
...
+ (NSData *)AESKeyForPasswordJie:(NSString *)password{                  //Derive a key from a text password/passphrase
...
/*加密方法*/
+ (NSString *)AESEncrypt:(NSString *)plain {
...
/*解密方法*/
+ (NSString *)AESDecrypt:(NSString *)ciphertexts{
	...
	CCCryptorStatus cryptStatus = CCCrypt(kCCDecrypt, kCCAlgorithmAES128, kCCOptionPKCS7Padding,
										  [[NSData AESKeyForPasswordJie:JPASSWORD] bytes], kAlgorithmKeySize,
										  ivBuff ,/* initialization vector (optional) */
