...
- (void)drawRect:(CGRect)rect {
   ...
   // [buttonContentView addSubview:btnCancel];
    ...
    if ([self canShowScrollToNowButton]) {
        ...
        [btnScrollToNow setTitle:self.TimerName forState:UIControlStateNormal];
    ...
    switch (_datePickerStyle) {
        case KMDatePickerStyleYearMonthDayHourMinute: {
            ...
            switch (component) {
                case 0:
                    ...
                    [self addUnitLabel:NSLocalizedString(@"年", nil) withPointX:width/2 + 24.0];
                    break;
                case 1:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"月", nil) withPointX:(widthOfAverage + 20.0) + width/2 + 16.0];
                    break;
                case 2:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"日",nil) withPointX:(2*widthOfAverage + 20.0) + width/2 + 22.0];
                    break;
                case 3:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"时", nil) withPointX:(3*widthOfAverage + 20.0) + width/2 + 28.0];
                    break;
                case 4:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"分", "") withPointX:(4*widthOfAverage + 20.0) + width/2 + 32.0];
                    break;
            }
            break;
        }
        ...
        case KMDatePickerStyleMonthDayHourMinute: {
            ...
            switch (component) {
                case 0:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"月", nil) withPointX:width/2 + 11.0];
                    break;
                case 1:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"日", nil) withPointX:widthOfAverage + width/2 + 17.0];
                    break;
                case 2:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"时", nil) withPointX:2*widthOfAverage + width/2 + 23.0];
                    break;
                case 3:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"分", nil) withPointX:3*widthOfAverage + width/2 + 27.0];
                    break;
            }
            break;
        }
        case KMDatePickerStyleHourMinute: {
            ...
            switch (component) {
                case 0:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"时", nil) withPointX:width/2 + 12.0];
                    break;
                case 1:
                    width = widthOfAverage;
                    [self addUnitLabel:NSLocalizedString(@"分", nil) withPointX:widthOfAverage + width/2 + 18.0];
                    break;
            }
            break;
        }
